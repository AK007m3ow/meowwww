...
no_button.addEventListener('click', () => {
    ...
    if (i < total - 1) {
        ...
        i = 1; // Reset to the first phrase after reaching the end
...
yes_button.addEventListener('click', () => {
    ...
    // Disable both buttons after selecting "Yes"
...
function changeLanguage() {
    ...
    // Reset clicks to start from the beginning
    clicks = 0;
    i = 1;
    ...
    // Enable buttons if switching languages
